...
return array(
  ...
  'jpegoptimPath' => '/usr/local/Cellar/jpegoptim/1.4.6/bin/jpegoptim',
  ...
  'optipngEnabled' => true,
  'optipngPath' => '/usr/local/Cellar.optipng/0.7.7/bin/optipng',
  ...
  'imgixEnabled' => true,
  'imgixDomains' => ['heron.imgix.net'],
  'imgixUseHttps' => true,
  'imgixSignKey' => 'm6GWgcVgmrHoaRA3bxx1Wk1a3zH9lzw1', // this is also called `security token`, and you'll find it in your Imgix source details page
  'imgixSourceIsWebProxy' => true,
  ...
  'imgixDefaultParams' => ['auto'=>'compress,format', 'q'=>80],
